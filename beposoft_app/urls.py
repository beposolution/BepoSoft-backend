...
urlpatterns = [
    ...
    path('api/family/orders/',FamilyBasedOrderGetView.as_view(),name="familys"),
    path('api/family/department/orders/',FamilyBasedBDOBDMOrderGetView.as_view()),
    path('api/family/bdm/bdo/orders/',BDOBDMFamilyBasedOrderGetView.as_view()),
    ...
    path('api/product/confirmation/<int:pk>/',ProductConfirmation.as_view(),name="product-confirmation"),
    ...
    path("api/orders/cycling/skating/", CyclingSkatingOrderListView.as_view()),
    path("api/orders/all/", OrderListWithoutPaginationView.as_view(), name="orders-all-without-pagination"),
    path('api/orders/today/', TodayOrderListView.as_view(), name='today-order-list'),
    ...
    path('api/orders/hourly/summary/', OrderHourlySummaryView.as_view(), name='order-hourly-summary'),
    path('api/orders/hourly/family/<int:family_id>/', FamilyOrderHourlyDetailView.as_view(), name='family-order-hourly-detail'),
    ...
    path("api/company/data/edit/<int:id>/", CompanyDetailsEditView.as_view()),
    ...
    path('api/perfoma/invoices/new/',PerfomaInvoiceListViewNew.as_view()),
    ...
    path("api/category/wise/product/count/date/<str:date>/", CategoryWiseProductCountDateView.as_view()),
    ...
    path('api/grv/cycling/skating/', CyclingSkatingGRVGETView.as_view()),
    path('api/my/grv/data/', MyGRVGETView.as_view()),
    ...
    path('api/warehouse/products/gets/<int:warehouse_id>/',GETProductByWarehouseView.as_view()),
    path('api/warehouse/products/<int:warehouse_id>/get/',ProductByWarehouseGETView.as_view()),
    ...
    path('api/call/report/staff/summary/', StaffCallSummaryView.as_view(), name='staff-call-summary'),
    path('api/call/report/state/summary/', StateWiseCallSummaryView.as_view(), name='call-report-state-summary'),
    ...
    path('api/call/reports/family/<int:family_id>/user-wise-call/report/<str:from_date>/<str:to_date>/',FamilyUserWiseCallReportView.as_view()),
    ...
    path("api/staff/attendance/my/details/", MyStaffAttendanceDetailsView.as_view()),
    ...
    path('api/products/main/category/wise/summary/', MainCategoryWiseProductSummaryAPIView.as_view(), name='main-category-wise-product-summary'),
