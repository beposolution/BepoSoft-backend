...
class Warehousedata(models.Model):
    ...
    breadth=models.CharField(max_length=30, null=True, blank=True)
    ...
    packed_by=models.ForeignKey(User,on_delete=models.CASCADE, null=True,related_name='packed_user')
